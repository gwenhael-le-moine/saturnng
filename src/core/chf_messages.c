...
ChfTable message_table[] = {
    ...
    {CHF_MODULE_NAMES_SET,  BUS_CHF_MODULE_ID,       "MOD"                                                                                   },
    ...
    {BUS_CHF_MODULE_ID,     BUS_I_CALLED,            "Function [%s] called"                                                                  },
    {BUS_CHF_MODULE_ID,     BUS_I_INITIALIZING,      "Initializing module [%s]"                                                              },
    {BUS_CHF_MODULE_ID,     BUS_I_RESETTING,         "Resetting module [%s]"                                                                 },
    {BUS_CHF_MODULE_ID,     BUS_I_GET_ID,            "bus_get_id -> [%05X]"                                                                  },
    {BUS_CHF_MODULE_ID,     BUS_I_CONFIG,            "CONFIG M[%s] A[%05X] S[%05X]"                                                          },
    {BUS_CHF_MODULE_ID,     BUS_I_UNCONFIG,          "UNCNFG M[%s] A[%05X] S[%05X]"                                                          },
    {BUS_CHF_MODULE_ID,     BUS_I_SAVING,            "Saving module [%s]"                                                                    },
    {BUS_CHF_MODULE_ID,     BUS_I_NOT_IMPLEMENTED,   "Function [%s] not implemented"                                                         },
    {BUS_CHF_MODULE_ID,     BUS_I_REVISION,          "Modules emulator: [%s]"                                                                },
    {BUS_CHF_MODULE_ID,     BUS_I_BS_ADDRESS,        "Bank Switcher F/F set to A[%05X]"                                                      },
    {BUS_CHF_MODULE_ID,     BUS_I_PORT_1_WP,         "Port 1 has been write-protected"                                                       },
    {BUS_CHF_MODULE_ID,     BUS_I_PORT_2_WP,         "Port 2 has been write-protected"                                                       },
    {BUS_CHF_MODULE_ID,     BUS_I_PERF_CTR,          ">>> PerfCtr [%s]=[%d]"                                                                 },
    {BUS_CHF_MODULE_ID,     BUS_I_CACHED_UNCONFIG,   "Cached UNCNFG completed"                                                               },
    {BUS_CHF_MODULE_ID,     BUS_I_CACHED_CONFIG,     "Cached CONFIG A[%05X] completed"                                                       },
    {BUS_CHF_MODULE_ID,     BUS_I_UNCONFIG_L_HIT,    "Late UNCNFG cache hit"                                                                 },
    {BUS_CHF_MODULE_ID,     BUS_I_UNCONFIG_L_MISS,   "Late UNCNFG cache miss"                                                                },
    {BUS_CHF_MODULE_ID,     BUS_W_BAD_CONFIG,        "Bad bus_configure [%05X] ignored"                                                      },
    {BUS_CHF_MODULE_ID,     BUS_W_BAD_UNCONFIG,      "Bad bus_unconfigure [%05X] ignored"                                                    },
    {BUS_CHF_MODULE_ID,     BUS_W_HDW_WRITE,         "Bad hdw_write A[%05X] N[%01X]"                                                          },
    {BUS_CHF_MODULE_ID,     BUS_W_HDW_READ,          "Bad hdw_read A[%05X]"                                                                   },
    {BUS_CHF_MODULE_ID,     BUS_W_RESETTING_ALL,     "Resetting all modules"                                                                 },
    {BUS_CHF_MODULE_ID,     BUS_W_RAM_INIT,          "Can't initialize internal RAM from disk"                                               },
    {BUS_CHF_MODULE_ID,     BUS_W_HDW_INIT,          "Can't initialize HDW from disk"                                                        },
    {BUS_CHF_MODULE_ID,     BUS_W_BAD_KEY,           "Bad key [%s] ignored"                                                                  },
    {BUS_CHF_MODULE_ID,     BUS_W_BAD_OUT_BIT,       "Bad out_bit [%x] ignored"                                                              },
    {BUS_CHF_MODULE_ID,     BUS_W_PORT_1_INIT,       "Can't initialize Port 1 from disk"                                                     },
    {BUS_CHF_MODULE_ID,     BUS_W_PORT_2_INIT,       "Can't initialize Port 2 from disk"                                                     },
    {BUS_CHF_MODULE_ID,     BUS_W_NO_VICTIM,         "Unable to find CONFIG cache victim; flushing cache"                                    },
    {BUS_CHF_MODULE_ID,     BUS_E_BAD_READ,          "Read from unmapped A[%05X]"                                                            },
    {BUS_CHF_MODULE_ID,     BUS_E_BAD_WRITE,         "Write to unmapped A[%05X] N[%01X]"                                                     },
    {BUS_CHF_MODULE_ID,     BUS_E_ROM_WRITE,         "Write into ROM A[%05X] D[%01X]"                                                        },
    {BUS_CHF_MODULE_ID,     BUS_E_RAM_SAVE,          "Can't save internal RAM status to disk"                                                },
    {BUS_CHF_MODULE_ID,     BUS_E_HDW_SAVE,          "Can't save HDW status to disk"                                                         },
    {BUS_CHF_MODULE_ID,     BUS_E_PORT_1_SAVE,       "Can't save Port 1 status to disk"                                                      },
    {BUS_CHF_MODULE_ID,     BUS_E_CE1_WRITE,         "Write into CE1 A[%05X] D[%01X]"                                                        },
    {BUS_CHF_MODULE_ID,     BUS_E_PORT_2_SAVE,       "Can't save Port 1 status to disk"                                                      },
    {BUS_CHF_MODULE_ID,     BUS_E_NCE3_READ,         "Read from NCE3 A[%05X] when Port 2 is not present"                                     },
    {BUS_CHF_MODULE_ID,     BUS_E_NCE3_WRITE,        "Write into NCE3 A[%05X] D[%01X] when Port 2 is not present"                            },
    {BUS_CHF_MODULE_ID,     BUS_E_NO_MATCH,          "Hardware configuration [%s] not supported"                                             },
    {BUS_CHF_MODULE_ID,     BUS_E_ROM_SAVE,          "Can't save Flash ROM status to disk"                                                   },
    {BUS_CHF_MODULE_ID,     BUS_F_MAP_SAVE,          "Can't save module mapping info"                                                        },
    {BUS_CHF_MODULE_ID,     BUS_F_ROM_INIT,          "Can't initialize internal ROM"                                                         },
    {BUS_CHF_MODULE_ID,     BUS_F_MAP_ALLOC,         "Dynamic allocation of BusMap failed"                                                   },
    {BUS_CHF_MODULE_ID,     BUS_F_BAD_ALLOC_C,       "Bad alloc_c [%d] after FlushCache()"                                                   },
    {BUS_CHF_MODULE_ID,     BUS_F_CHAIN_CORRUPTED,   "Cached struct BusMap chain corrupted; freeing unlinked entry"                          },
    {BUS_CHF_MODULE_ID,     BUS_F_NO_VICTIM,         "Unable to find CONFIG cache victim after cache flush"                                  },
    {BUS_CHF_MODULE_ID,     BUS_F_BUS_STATUS_ALLOC,  "Allocation of BusStatus_xx failed ([%d]d bytes needed)"                                },
    {BUS_CHF_MODULE_ID,     BUS_F_NO_DESCRIPTION,    "bus_init() invoked without registering a BusDescription first"                         },
    {BUS_CHF_MODULE_ID,     BUS_M_NOT_MAPPED,        "A[%05X] -> *Not Mapped*"                                                               },
    {BUS_CHF_MODULE_ID,     BUS_M_MAPPED,            "A[%05X] -> M[%s] R[%05X]"                                                              },
    {BUS_CHF_MODULE_ID,     BUS_M_MAP_TABLE_TITLE,   "Device\t\t\tAddress\tSize\tStatus"                                                     },
    {BUS_CHF_MODULE_ID,     BUS_M_MAP_TABLE_ROW,     "%s\t%05X\t%05X\t%s"                                                                    },
    {BUS_CHF_MODULE_ID,     BUS_M_MAP_CONFIGURED,    "Configured"                                                                            },
    {BUS_CHF_MODULE_ID,     BUS_M_MAP_SZ_CONFIGURED, "Size_configured"                                                                       },
    {BUS_CHF_MODULE_ID,     BUS_M_MAP_UNCONFIGURED,  "*Unconfigured*"                                                                        },
